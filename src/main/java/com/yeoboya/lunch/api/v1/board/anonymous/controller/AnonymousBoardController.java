...
public class AnonymousBoardController {
    ...
    public ResponseEntity<Response.Body> write(@RequestBody AnonymousBoardCreate request,
                                               @RequestHeader(value = "X-Anonymous-Client-UUID", required = false) String uuid,
    ...
    public ResponseEntity<Response.Body> report(@RequestBody AnonymousBoardReport anonymousBoardReport,
                                                @RequestHeader("X-Anonymous-Client-UUID") String clientUUID) {
    ...
    public ResponseEntity<Response.Body> syncLatestForClient(@RequestHeader("X-Anonymous-Client-UUID") String uuid) {
