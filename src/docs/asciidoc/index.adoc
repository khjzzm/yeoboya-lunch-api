...
include::{snippets}/freeBoard/write/http-request.adoc[]
include::{snippets}/freeBoard/write/request-fields.adoc[]

==== http-response

include::{snippets}/freeBoard/write/http-response.adoc[]
include::{snippets}/freeBoard/write/response-fields.adoc[]

=== 게시글 수정

==== http-request

include::{snippets}/freeBoard/update/http-request.adoc[]
include::{snippets}/freeBoard/update/request-fields.adoc[]

==== http-response

include::{snippets}/freeBoard/update/http-response.adoc[]
include::{snippets}/freeBoard/update/response-fields.adoc[]

=== 게시글 등록(파일첨부)

==== http-request

include::{snippets}/freeBoard/write/photo/http-request.adoc[]
include::{snippets}/freeBoard/write/photo/request-fields.adoc[]

==== http-response

include::{snippets}/freeBoard/write/photo/http-response.adoc[]
include::{snippets}/freeBoard/write/photo/response-fields.adoc[]

=== 게시글 리스트 조회

==== http-request

include::{snippets}/freeBoard/http-request.adoc[]
include::{snippets}/freeBoard/request-parameters.adoc[]

==== http-response

include::{snippets}/freeBoard/http-response.adoc[]
include::{snippets}/freeBoard/response-fields.adoc[]

=== 게시글 단건 조회

==== http-request

include::{snippets}/freeBoard/get/http-request.adoc[]
include::{snippets}/freeBoard/get/path-parameters.adoc[]

==== http-response

include::{snippets}/freeBoard/get/http-response.adoc[]
include::{snippets}/freeBoard/get/response-fields.adoc[]

=== 게시글 댓글 작성

==== http-request

include::{snippets}/freeBoard/reply/write/http-request.adoc[]
include::{snippets}/freeBoard/reply/write/request-fields.adoc[]

==== http-response

include::{snippets}/freeBoard/reply/write/http-response.adoc[]
include::{snippets}/freeBoard/reply/write/response-fields.adoc[]

=== 게시글 댓글 조회

==== http-request

include::{snippets}/freeBoard/reply/http-request.adoc[]
include::{snippets}/freeBoard/reply/request-parameters.adoc[]

==== http-response

include::{snippets}/freeBoard/reply/http-response.adoc[]
include::{snippets}/freeBoard/reply/response-fields.adoc[]

=== 게시글 대댓글 작성

==== http-request

include::{snippets}/freeBoard/nestedComment/write/http-request.adoc[]
include::{snippets}/freeBoard/nestedComment/write/request-fields.adoc[]

==== http-response

include::{snippets}/freeBoard/nestedComment/write/http-response.adoc[]
include::{snippets}/freeBoard/nestedComment/write/response-fields.adoc[]

=== 게시글 대댓글 조회

==== http-request

include::{snippets}/freeBoard/nestedComment/reply/http-request.adoc[]
include::{snippets}/freeBoard/nestedComment/reply/request-parameters.adoc[]

==== http-response

include::{snippets}/freeBoard/nestedComment/reply/http-response.adoc[]
include::{snippets}/freeBoard/nestedComment/reply/response-fields.adoc[]

=== 좋아요

==== http-request

include::{snippets}/freeBoard/like/http-request.adoc[]
include::{snippets}/freeBoard/like/path-parameters.adoc[]

==== http-response

include::{snippets}/freeBoard/like/http-response.adoc[]
include::{snippets}/freeBoard/like/response-fields.adoc[]

=== 좋아요 취소

==== http-request

include::{snippets}/freeBoard/like/delete/http-request.adoc[]
include::{snippets}/freeBoard/like/delete/path-parameters.adoc[]

==== http-response

include::{snippets}/freeBoard/like/delete/http-response.adoc[]
include::{snippets}/freeBoard/like/delete/response-fields.adoc[]
...
include::{snippets}/resource/http-request.adoc[]
include::{snippets}/resource/request-parameters.adoc[]

==== http-response

include::{snippets}/resource/http-response.adoc[]
include::{snippets}/resource/response-fields.adoc[]

=== 리소스 추가 및 수정

==== http-request

include::{snippets}/resource/add/http-request.adoc[]
include::{snippets}/resource/add/request-body.adoc[]

==== http-response

include::{snippets}/resource/add/http-response.adoc[]
include::{snippets}/resource/add/response-fields.adoc[]
